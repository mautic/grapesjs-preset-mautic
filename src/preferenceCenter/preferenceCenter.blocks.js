  ...
  addPreferenceCenterBlock() {
    ...
    this.blockManager.add('MyCategories', {
      ...
      content: {
        components: [
          {
            components: [{ type: 'label', components: 'My Categories' }],
          },
          {
            components: [
              {
                type: 'checkbox',
                attributes: { value: 1, checked: 'checked' },
              },
    ...
    this.blockManager.add('MySegment', {
      ...
      content: {
        ...
        components: [
          {
            components: [{ type: 'label', components: 'My Segment' }],
          },
          {
            components: [
              {
                type: 'checkbox',
                attributes: { value: 2, checked: 'checked' },
              },
    ...
    this.blockManager.add('SuccessMessage', {
      ...
      content: {
        ...
        components: [
          {
            components: [{ type: 'text', components: 'Preference Saved.' }],
          },
        ],
      },
      style: { padding: '50px' },
