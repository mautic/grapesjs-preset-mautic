  ...
  addPreferenceCenterBlock() {
    this.blockManager.add('MauticSegment', {
      ...
      content: `<div data-slot="segmentlist">
          <div>
            <div>
              <label>${Mautic.translate('grapesjsbuilder.preferenceCenter.block.MauticSegments.label')}</label>
            </div>
            <div>
              <input
                type="checkbox"
              ...
              />
              <label>${Mautic.translate('grapesjsbuilder.preferenceCenter.block.MauticSegments.text')}</label>
            </div>
          </div>
        </div>`,
      style: {
    ...
    this.blockManager.add('MauticCategories', {
      ...
      content: `<div data-slot="categorylist">
          <div>
            <div>
              <label>${Mautic.translate('grapesjsbuilder.preferenceCenter.block.MauticCategories.label')}</label>
            </div>
            <div>
              <input
                type="checkbox"
              ...
              />
              <label>${Mautic.translate('grapesjsbuilder.preferenceCenter.block.MauticCategories.text')}</label>
            </div>
          </div>
        </div>`,
      style: {
    ...
    this.blockManager.add('PreferredChannel', {
      ...
      content: `<div data-slot="preferredchannel">
          <div>
            <label>${Mautic.translate('grapesjsbuilder.preferenceCenter.block.preferredChannel.label')}</label>
            <div>
              <select>
              ...
              <tr>
                <td>
                  <div id="frequency_email" class="text-left row">
                    <div>
                      <label>${Mautic.translate('grapesjsbuilder.preferenceCenter.block.channelFrequency.text.number')}</label>
                      <input type="number" min="0" class="frequency form-control">
                      <label class="fw-n frequency-label">${Mautic.translate('grapesjsbuilder.preferenceCenter.block.channelFrequency.text.each')}</label>
                    ...
                    <div>
                      <label>${Mautic.translate('grapesjsbuilder.preferenceCenter.block.channelFrequency.text.pause_from')}</label>
                      <input type="date" class="form-control">
                      <label class="frequency-label fw-n">${Mautic.translate('grapesjsbuilder.preferenceCenter.block.channelFrequency.text.pause_to')}</label>
                      <input type="date" class="form-control">
                    </div>
                  </div>
                </td>
    ...
    this.blockManager.add('SuccessMessage', {
      ...
      content: `
        <div data-slot="successmessage">
            <span>${Mautic.translate('grapesjsbuilder.preferenceCenter.block.successMessage.label')}</span>
        </div>`,
      style: {
        padding: '50px'
      }
    ...
    this.blockManager.add('UnsubscribeAll', {
      ...
      content: `<div data-slot="donotcontact">
            <a href="{dnc_url}">${Mautic.translate('grapesjsbuilder.preferenceCenter.block.unsubscribeAll.link')}</a> 
            <span> ${Mautic.translate('grapesjsbuilder.preferenceCenter.block.unsubscribeAll.text')}</span>
        </div>`,
      style: {
        padding: '50px'
      }
